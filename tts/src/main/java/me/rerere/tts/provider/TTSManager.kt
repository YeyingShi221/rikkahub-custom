...
import me.rerere.tts.provider.providers.FishSpeechTTSProvider
...
class TTSManager(private val context: Context) {
    ...
    private val fishSpeechProvider = FishSpeechTTSProvider()
    ...
    fun generateSpeech(
        ...
        return when (providerSetting) {
            ...
            is TTSProviderSetting.FishSpeech -> fishSpeechProvider.generateSpeech(context, providerSetting, request)
        }
    }
}
